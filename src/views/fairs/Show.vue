    ...
    <v-container>
        ...
        <v-window v-model="tab">
                        ...
                        <v-row align="center">
                            <v-col cols="10">
                                ...
                                <v-btn-group v-if="!item.published" density="compact">
                                    ...
                                    <ConfirmationDialog :visible="confDialog" @accept="deleteFair"
            ...
            <v-window-item value="two">
                <v-row justify="center" v-show="ds.roleCheck('organizer') && item.organizer_id == ds.user.id" class="pa-5">
                            ...
                            <v-card>
                                ...
                                <v-card-text>
                                    <v-row>
                                        ...
                                        <v-col>
                                            <v-select prepend-inner-icon="location_city" v-model="city" :items="cities"
                                                item-value="city" item-title="city" label="City" />
                                        </v-col>
                ...
                <v-row class="pa-5">
                    <v-col md="4" v-for="cmpny in guests" :key="cmpny.id" v-if="guests.length">
                        <CompanyCard :company="cmpny" :trimText="150"
                            :deletable="ds.roleCheck('organizer') && ds.user.id == item.organizer_id" :fair="item.id" :invitable="false" />
                    </v-col>
